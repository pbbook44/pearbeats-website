export const uiTexts = {
  de: {
    ...
    about: {
      ...
      title: 'Booking mit Leidenschaft für Creative Music',
      desc1: 'pearbeats ist eine unabhängige Booking-Agentur mit Sitz in Berlin, Deutschland. Wir vermitteln Musiker*innen an Festivals, Clubs und Kulturveranstalter in ganz Europa.',
      desc2: 'Unsere Mission: außergewöhnliche Live-Erlebnisse schaffen – durch sorgfältig kuratierte Line-ups, persönliche Betreuung und ein tiefes Verständnis für die Musikszene.',
      stats1: 'Künstler*innen im Roster',
      stats2: 'Gebuchte Shows pro Jahr',
      stats3: 'Veranstaltungen im Fokus',
      guaranteeTitle: 'pearbeats-Garantie',
      guaranteeDesc: 'Jedes Booking wird mit der gleichen Sorgfalt behandelt – ob intimer Club oder Mainstage.',
    },
    ...
    contact: { 
      ...
      typeOptions: ['Booking', 'Als Artist bewerben', 'Presse/Kooperation', 'Sonstiges'],
      // Bewerbung
  ...
  en: {
    ...
    about: {
      ...
      title: 'Booking with Passion for Creative Music',
      desc1: 'pearbeats is an independent booking agency based in Berlin, Germany. We connect musicians with festivals, clubs and cultural venues across Europe.',
      desc2: 'Our mission: creating extraordinary live experiences – through carefully curated line-ups, personal care and a deep understanding of the music scene.',
      stats1: 'Artists in Roster',
      stats2: 'Shows Booked Per Year',
      stats3: 'Events in Focus',
      guaranteeTitle: 'pearbeats Guarantee',
      guaranteeDesc: 'We treat every booking with the same care, whether it\'s an intimate club or the main stage.',
    },
    artists: { label: 'Our Roster', title: 'Featured Artists', subtitle: 'A selection of our artists. Full roster upon request.' },
    services: {
      label: 'Services',
      title: 'What we do',
      subtitle: 'We will accompany you through the entire booking process, from your first enquiry to your final note.',
      s1Title: 'Artist Booking',
    ...
    contact: { 
      ...
      typeOptions: ['Booking', 'Apply as Artist', 'Press/Cooperation', 'Other'],
      artistName: 'Artist / Ensemble Name',
